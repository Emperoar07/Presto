        ...
        <div className="mx-auto flex h-[66px] max-w-[1140px] items-center px-4 md:px-7">
          ...
          <div className="mr-5 hidden gap-0.5 md:flex">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-[13px] font-medium text-[#94a3b8] transition-all hover:bg-white/[0.04] hover:text-[#f1f5f9]"
            >
              <span>Markets</span>
              <span className="rounded-full border border-emerald-500/30 bg-emerald-500/10 px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-wider text-emerald-400 shadow-[0_0_6px_rgba(16,185,129,0.1)]">
                New
              </span>
            </a>
          </div>
